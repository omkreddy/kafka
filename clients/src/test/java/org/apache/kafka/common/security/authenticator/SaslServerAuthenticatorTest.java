...
public class SaslServerAuthenticatorTest {
    ...
    private SaslServerAuthenticator setupAuthenticator(Map<String, ?> configs, TransportLayer transportLayer,
        ...
        Map<String, Integer> saslServerMaxReceiveSizeByMechanism = Collections.singletonMap(mechanism,
                BrokerSecurityConfigs.DEFAULT_SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE);
        ...
        return new SaslServerAuthenticator(configs, callbackHandlers, "node", subjects, null,
                ...
                saslServerMaxReceiveSizeByMechanism, metadataRegistry, time, () -> apiVersionsResponse);
    }
