...
public class TestSecurityConfig extends AbstractConfig {
    private static final ConfigDef CONFIG = new ConfigDef()
            ...
            .define(BrokerSecurityConfigs.SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE_CONFIG, Type.INT, BrokerSecurityConfigs.DEFAULT_SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE,
                    Importance.LOW, BrokerSecurityConfigs.SASL_SERVER_AUTHN_MAX_RECEIVE_SIZE_DOC)
